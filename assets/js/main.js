...
Template Name: Rapid Mover Transports - Transport & Logistics
Author:  pixel-drop
Author URI: https://themeforest.net/user/pixel-drop/portfolio/portfolio
Version: 1.0.0
Description: Rapid Mover Transports - Transport & Logistics<
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    //>> Active Js Start <<//
    $(".team-box-items, .news-box-items").hover(function () {
